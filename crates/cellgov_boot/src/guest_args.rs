...
pub enum GuestArgsError {
    /// One argument holds a NUL, which would truncate it in the guest.
    ...
    BlockTooLarge {
        /// Bytes the pointer table and string storage need.
        total: u64,
        /// The primary stack reservation it did not fit.
        stack_size: u64,
    },
}
