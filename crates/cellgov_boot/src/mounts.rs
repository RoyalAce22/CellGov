...
/// it, in probe order.
///
/// [`crate::prepare`] registers these before the manifest's own mounts,
/// so a manifest prefix that encloses a composed one cannot answer
/// first.
...
pub enum MountRegisterError {
    ...
    InvalidPrefix {
        /// The guest prefix the entry declares.
        prefix: String,
    ...
    InvalidHost {
        /// The guest prefix the entry declares.
        prefix: String,
        /// The host string the entry declares.
        host: String,
        /// Which shape rule it broke.
        reason: String,
    },
    ...
    HostRootMissing {
        /// The guest prefix the entry declares.
        prefix: String,
        /// The host directory the entry resolved to.
        host_path: PathBuf,
    ...
    HostRootNotDirectory {
        /// The guest prefix the entry declares.
        prefix: String,
        /// The host path the entry resolved to.
        host_path: PathBuf,
        /// Override env var name, surfaced in Display.
        override_env: Option<String>,
    },
    ...
    HostRootIo {
        /// The guest prefix the entry declares.
        prefix: String,
        /// The host path the probe was refused on.
        host_path: PathBuf,
        /// What the probe refused with.
        #[source]
        source: std::io::Error,
        /// Override env var name, surfaced in Display.
        override_env: Option<String>,
    ...
    DuplicatePrefix {
        /// The guest prefix already answered by another mount.
        prefix: String,
    },
    ...
    NoHost {
        /// The guest prefix the entry declares.
        prefix: String,
        /// The override env var the entry declares, if any.
        override_env: Option<String>,
    },
}
