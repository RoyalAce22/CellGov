//! Vector-unit execution, with typed-vs-VX-stub path equivalence.
...
fn vaddubm_adds_each_byte_modulo_256() {
    ...
    let va = u128::from_be_bytes([
        0xFF, 0x10, 0x7F, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C,
        0x0D,
    ]);
    let vb = u128::from_be_bytes([
        0x01, 0x20, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ]);
    let expected = u128::from_be_bytes([
        0x00, 0x30, 0xFE, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C,
        0x0D,
    ]);
...
fn vadduhm_adds_each_halfword_modulo_65536() {
    ...
    let va = u128::from_be_bytes([
        0xFF, 0xFF, 0x12, 0x34, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ]);
    let vb = u128::from_be_bytes([
        0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ]);
    let expected = u128::from_be_bytes([
        0x00, 0x00, 0x12, 0x35, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ]);
...
fn vsrah_arithmetic_shifts_low_4_bits_of_each_halfword() {
    ...
    let va = u128::from_be_bytes([
        0x80, 0x00, 0x40, 0x00, 0xFF, 0xFF, 0xFF, 0xF8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ]);
    let vb = u128::from_be_bytes([
        0x00, 0x04, 0x00, 0x02, 0x00, 0x0F, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ]);
    let expected = u128::from_be_bytes([
        0xF8, 0x00, 0x10, 0x00, 0xFF, 0xFF, 0xFF, 0xFC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ]);
...
fn vsrab_arithmetic_shifts_low_3_bits_of_each_byte() {
    ...
    let va = u128::from_be_bytes([
        0x80, 0x40, 0xFF, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ]);
    let vb = u128::from_be_bytes([
        0x01, 0x01, 0x07, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ]);
    let expected = u128::from_be_bytes([
        0xC0, 0x20, 0xFF, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ]);
...
fn vmrghb_interleaves_high_8_bytes_of_a_and_b() {
    ...
    let expected = u128::from_be_bytes([
        0xA0, 0xB0, 0xA1, 0xB1, 0xA2, 0xB2, 0xA3, 0xB3, 0xA4, 0xB4, 0xA5, 0xB5, 0xA6, 0xB6, 0xA7,
        0xB7,
    ]);
...
fn vmrghh_interleaves_high_4_halfwords_of_a_and_b() {
    ...
    let expected = u128::from_be_bytes([
        0xA0, 0xA1, 0xB0, 0xB1, 0xA2, 0xA3, 0xB2, 0xB3, 0xA4, 0xA5, 0xB4, 0xB5, 0xA6, 0xA7, 0xB6,
        0xB7,
    ]);
...
fn vmrglb_interleaves_low_8_bytes_of_a_and_b() {
    ...
    let expected = u128::from_be_bytes([
        0xA8, 0xB8, 0xA9, 0xB9, 0xAA, 0xBA, 0xAB, 0xBB, 0xAC, 0xBC, 0xAD, 0xBD, 0xAE, 0xBE, 0xAF,
        0xBF,
    ]);
...
fn vmrglh_interleaves_low_4_halfwords_of_a_and_b() {
    ...
    let expected = u128::from_be_bytes([
        0xA8, 0xA9, 0xB8, 0xB9, 0xAA, 0xAB, 0xBA, 0xBB, 0xAC, 0xAD, 0xBC, 0xBD, 0xAE, 0xAF, 0xBE,
        0xBF,
    ]);
...
fn vsububs_saturates_each_byte_subtract_to_zero() {
    ...
    // 0xFF - 0x00 = 0xFF.
    let va = u128::from_be_bytes([
        0x10, 0x05, 0x00, 0xFF, 0x80, 0x7F, 0x40, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ]);
    let vb = u128::from_be_bytes([
        0x05, 0x10, 0xFF, 0x00, 0x7F, 0x80, 0x40, 0x41, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ]);
    let expected = u128::from_be_bytes([
        0x0B, 0x00, 0x00, 0xFF, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ]);
...
fn vsel_picks_b_bits_where_c_is_one_else_a() {
    ...
    let expected = u128::from_be_bytes([
        0xBB, 0xAA, 0xBB, 0xAA, 0xBB, 0xAA, 0xBB, 0xAA, 0xBB, 0xAA, 0xBB, 0xAA, 0xBB, 0xAA, 0xBB,
        0xAA,
    ]);
...
fn vperm_indexes_concat_of_a_and_b_by_low_5_bits_of_c() {
    ...
    let vc = u128::from_be_bytes([
        0x00, 0x10, 0x0F, 0x1F, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ]);
    let expected = u128::from_be_bytes([
        0xA0, 0xB0, 0xAF, 0xBF, 0xA0, 0xA0, 0xA0, 0xA0, 0xA0, 0xA0, 0xA0, 0xA0, 0xA0, 0xA0, 0xA0,
        0xA0,
    ]);
