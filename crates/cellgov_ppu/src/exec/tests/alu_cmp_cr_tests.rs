...
fn mtcrf_reads_low_32_bits_of_rs() {
    let mut s = PpuState::new();
    s.set_gpr(3, 0xAAAA_AAAA_5555_5555);
    s.set_cr(0);
    exec_no_mem(
...
fn mtocrf_one_hot_crm_updates_only_selected_field() {
    let mut s = PpuState::new();
    s.set_gpr(3, 0xAAAA_AAAA_1234_5678);
