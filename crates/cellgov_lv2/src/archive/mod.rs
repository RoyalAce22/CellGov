...
pub use spec::{
    ...
    CENSUS, CENSUS_CLASSES, CENSUS_GATE, CENSUS_REGENERATE, COMPARISON_STATES, CONFLICTS,
    DISAGREEMENTS, DISCOVERY_CONFIDENCE, DISCOVERY_METHODS, DISPATCH_SHAPES, ENTRY_FORMATS,
    EXCEPTIONS, FIDELITY_LABELS, FIRMWARE, FIRMWARE_GATE, FIRMWARE_ROLES, GATE, GATE_STATES,
    KERNEL, NAME, NAME_GATE, NAME_REGENERATE, NAME_SOURCES, PRESENCE, PRIMARY_LABELS,
