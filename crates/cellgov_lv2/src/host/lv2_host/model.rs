    ...
    pub fn new() -> Self {
        ...
        Self {
            state: state::Lv2State {
                ...
                mmapper_ipc: cellgov_mem::lanes::LaneMap::new(
                    cellgov_mem::lanes::source::MMAPPER_IPC,
                    |key| key,
                ),
                config: crate::host::config::ConfigTable::new(),
                uart: crate::host::uart::UartState::new(),
                usbd: crate::host::usbd::UsbdState::new(),
                memory_containers: cellgov_mem::lanes::LaneMap::new(
                    cellgov_mem::lanes::source::MEMORY_CONTAINER,
                    u64::from,
                ),
