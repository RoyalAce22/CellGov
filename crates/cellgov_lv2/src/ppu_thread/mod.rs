...
//!
//! The runtime observes only `UnitStatus::Blocked`; the
//! guest-semantic block reason lives here so the host can
//! transition the unit back to runnable when its condition
//! resolves.
