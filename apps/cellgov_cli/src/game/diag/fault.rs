...
use crate::game::step_loop::{block_reason_label, PcRing};
...
pub(in crate::game) fn unit_memory(rt: &Runtime, unit: cellgov_event::UnitId) -> &GuestMemory {
...
pub(in crate::game) fn format_deadlock(rt: &Runtime, steps: usize, pc_ring: &PcRing) -> String {
