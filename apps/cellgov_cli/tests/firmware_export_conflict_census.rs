...
//!
//! ```text
//! cargo test -p cellgov_cli --features firmware-corpus --test firmware_export_conflict_census --release \
...
fn regenerate_firmware_export_conflict_census() {
    ...
    writeln!(
        out,
        "Generated by `cargo test -p cellgov_cli --features firmware-corpus --test firmware_export_conflict_census --release -- --ignored regenerate_firmware_export_conflict_census`. The test writes this file directly; no stdout redirection."
    )
