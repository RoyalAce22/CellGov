...
| ------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `cellgov_ps3_abi`              | PS3 ABI source-of-truth leaf: NIDs (with `nid_const!` SHA-1 verification) and the global NID lookup table, LV2 errno database, LV2 syscall numbers and the r11 namespace split, ELF / PRX / SPRX layout, PARAM.SFO layout and title-tree names, CBE PPU hardware constants, RSX hardware constants under `rsx_nv_hardware.rs`, and the PPC64 encoders for CellGov's stub trampolines. External-ABI facts and pure functions over them; no guest state, no I/O. Zero workspace dependencies.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
