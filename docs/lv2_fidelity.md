...
| `ConfigAddServiceListener` | partial-state |
| `ConfigRemoveServiceListener` | modeled |
| `ConfigRegisterService` | partial-state |
| `ConfigUnregisterService` | modeled |
...
| `ProcessGetStatus` | partial-state |
